...
import {
  handleColoredSquareClick,
  handleNonColoredSquareClick,
  handleHighlightedSquareClick,
  resetMoveCounter,
  undoLastMove,
  clearMoveHistory,
  moveCount,
...
import {
  playSolvedSolution,
  solutionStepsCount,
} from "./solver/getSolution.js";

export const undoButton = document.getElementById("undo");
export const resetButton = document.getElementById("reset-robots");
...
function handleBoardClick(event) {
  ...
  if (clickedSquare.classList.contains("colored")) {
    ...
    !clickedSquare.classList.contains("highlighted")
  ) {
...
newTargetButton.addEventListener("click", () => {
  ...
  window.hasRecordedSolution = false;
});
...
newBoardButton.addEventListener("click", () => {
  ...
  newTargetButton.disabled = false;
...
solveButton.addEventListener("click", async () => {
  ...
  // Toggle the active class on first click
  if (isFirstClick) {
    solveButton.classList.add("solver-active"); // Apply active class
...
function resetRecordingButton() {
  ...
  recordingButton.classList.remove("recording-active");
}

function resetSolveButton() {
  solveButton.textContent = "Solve Board";
  solveButton.classList.remove("solver-active");
  isFirstClick = true;
}
...
recordingButton.addEventListener("click", () => {
  ...
  if (isRecording) {
    ...
    recordingButton.classList.add("recording-active");
