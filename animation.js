...
function animateSquareMovement(originalSquare, targetSquare, duration) {
    ...
    animatedSquare.style.backgroundColor = window.getComputedStyle(originalSquare).backgroundColor;
    ...
    function animate(time) {
        ...
        const currentX = originalRect.left + (targetRect.left - originalRect.left) * progress;
        const currentY = originalRect.top + (targetRect.top - originalRect.top) * progress;
